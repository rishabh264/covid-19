            ...
            <nav class="mb-4 navbar navbar-expand-lg navbar-dark bg-unique">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent-3">
                    ...
                    <ul class="navbar-nav ml-auto ">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="https://github.com/rishabh264/" target="_blank">{{__('covid19.api')}}</a>
                        </li>
                            ...
                            <div class="about">
                                ...
                                <div class="social-media">
                                    <ul class="list-inline">
                                        <li class="d-inline-block"><a href="http://www.facebook.com/" title=""><i class="fa fa-facebook"></i></a></li>
                                        <li class="d-inline-block"><a href="http://www.instagram.com/" title=""><i class="fa fa-instagram"></i></a></li>
                                        <li class="d-inline-block"><a href="http://www.linkedin.com/in/" title=""><i class="fa fa-linkedin"></i></a></li>
                                        <li class="d-inline-block"><a href="http://www.github.com/rishabh264" title=""><i class="fa fa-github"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
